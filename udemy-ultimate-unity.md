...
#### User Interface (UI)
    ...
    Challenging Review: Score System
    ...
    Code Cleanup
#### Effects (FX)
    Unity Effects (FX) Intro
    Challenge: Audio Sound Effects
    Challenge Review: Audio Sound Effects
    Powerup Animations
    Thrusters Animation
    Player Engine Failure
    Enemy Thruster Setup
...
#### Build Game
    ...
    Building Our Game
    Game Host
#### Galaxy Shooter - Recap and Review
    Galaxy Shooter - Recap and Review
#### Sci-Fi Tech Demo
    Sci-Fi Tech Demo Intro
#### Project Setup
    Project Setup Intro
    Project Setup
    Importing Assets in Unity
...
#### Post-Processing
    ...
    Unity's Post Processing Effects
    Build Game
#### Sci-Fi Tech Demo - Recap and Review
    Sci-Fi Tech Demo - Recap and Review
#### Conclusion
    Conclusion
#### Extended Content
    Challenge: Score Bug
    Challenge Review: Score Bug
    Co-Op Mode Intro
    Co-Op Mode Setup
